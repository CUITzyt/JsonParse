...
//		Log.i("zyt","" + list.get(0).get("question"));
//		Log.i("zyt","" + list.get(0).get("answer"));
//		
//		Log.i("zyt","" + list.get(1).get("question"));
//		Log.i("zyt","" + list.get(1).get("answer"));
